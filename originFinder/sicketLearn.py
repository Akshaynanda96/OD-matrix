...
def calculate_home_locations(df):
    ...
    # Get home locations
    start_time = time()
    home_origin = home_location(tdf, '22:00', '07:00')
    # afternoon_location = home_location(tdf, '7:01', '21:59')

    # logger.info(f'this is a after night data of person {afternoon_location}')
...
if __name__ == "__main__":
    ...
    result = calculate_home_locations(data)
    print("\nFinal Result:")
    print(result)